...
const DUMMY_COC = [
    {one: 'Purpose', two: ['WeTalkDATA & AI is a community-driven event created by and for data and AI enthusiasts. We are dedicated to providing an accepting environment that provides space for making friends and earning knowledge regardless of gender, gender identity and expression, sexual orientation, disability, physical appearance, body size, race, age, religion or lack thereof. Harassment of event attendees, speakers, sponsors and any others will not be tolerated at WeTalkDATA&AI. Event participants violating these rules may be sanctioned or expelled from the event. ']},
    {
        ...
        one: 'Enforcement',
        two: ['If you are subject to unacceptable behavior, notice that someone else is being subject to unacceptable behavior, or have any other concerns, please follow these steps:' ,
        ...
        one: 'Reporting',
        two: ['If you are subject to unacceptable behavior, notice that someone else is being subject to unacceptable behavior, or have any other concerns, please follow these steps: WeTalkData&AI event organizers can be identified through branded shirts/badges.' ,
