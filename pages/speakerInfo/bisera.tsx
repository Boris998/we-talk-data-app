    ...
    <SectionWrapperContainer>
      ...
      >
        ...
        <div className="space-y-3 md:text-left">
          <p
            className={`${FONTS.paragraph} text-[${PRIMARY_THEME_COLORS.tertiary}]/70`}
          >
            <span>{speakers[1].speakerName} | </span>
            <span>{speakers[1].jobTitle}</span>
          </p>
          <p className={`${FONTS.paragraph} ${PRIMARY_THEME_COLORS.textWhite}`}>
            <span className={`${PRIMARY_THEME_COLORS.tertiary} text-extrabold`}>
              Topic description:{" "}
            </span>
          ...
          <Link
            ...
            className={`text-[${PRIMARY_THEME_COLORS.tertiary}] hover:animate-pulse flex items-center justify-center relative`}
            target="_blank"
