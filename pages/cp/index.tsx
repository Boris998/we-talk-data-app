        ...
        <div className='py-24 px-10 overflow-hidden'>
            ...
            <div className='text-left space-y-8'>
                ...
                <div>
                    ...
                    <p className='text-[#ffd700] py-1'>Depending on how long they are stored on your device, cookies are categorized as &lsquo;permanent&rsquo; and &lsquo;temporary&rsquo; (&lsquo;session&rsquo;) cookies.</p>
                    <ul className='text-[#ffd700] list-disc pl-[20px] pb-2'>
                    ...
                    <ul className='text-[#ffd700] list-disc pl-[20px]'>
