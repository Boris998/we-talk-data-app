...
const CookiePolicy = () => {
    ...
    return <SectionWrapperContainer>
        ...
        {/*        <div>*/}
        {/*            <h2 className='font-extrabold text-[36px] text-white'>What does this policy involve?</h2>*/}
        {/*            <p className='text-[#ffd700] py-1'>WeTalkDATA&AI’s website uses cookies.</p>*/}
        {/*            <p className='text-[#ffd700] py-1'>To learn more about what cookies are, how they are used on our websites, and how to manage them, carefully read this Cookie Policy of WeTalkDATA&AI. </p>*/}
        {/*        </div>*/}
        {/*        <div>*/}
        {/*            <h2 className='font-extrabold text-[36px] text-white'>Cookies – what are they? </h2>*/}
        {/*            <p className='text-[#ffd700] py-1'>A ‘cookie’ is a small file containing data stored on your device's web browser when visiting specific websites.*/}
        ...
        {/*        </div>*/}
        {/*        <div>*/}
        {/*            <h2 className='font-extrabold text-[36px] text-white'>What are the types of cookies? </h2>*/}
        {/*            <p className='text-[#ffd700] py-1'>Depending on how long they are stored on your device, cookies are categorized as ‘permanent’ and ‘temporary’ (‘session’) cookies.</p>*/}
        {/*            <ul className='text-[#ffd700] list-disc'>*/}
        {/*                <li>Permanent cookies are stored on your computer or mobile device for a long period time, which can last years; </li>*/}
        ...
        {/*            </ul>*/}
        {/*            <p className='text-[#ffd700] py-1'>Depending on their features, cookies can generally be categorized as four different</p>*/}
        {/*            <ul className='text-[#ffd700] list-disc'>*/}
        ...
        {/*            <p className='text-[20px] pt-6 text-white'>Strictly necessary cookies:</p>*/}
        {/*            <p className='text-[#ffd700] py-1'>They are strictly necessary for our websites to perform their functions.*/}
        ...
        {/*            </p>*/}
        {/*            <p className='text-[20px] pt-6 text-white'>Functionality cookies</p>*/}
        {/*            <p className='text-[#ffd700] py-1'>These cookies deliver the various functionalities of our websites. They enable us to remember your preferences, such as font size and other preferences,*/}
        {/*                saving you time and effort to indicate a user name every time you visit our website or to view content preferred by you.*/}
        ...
        {/*            </p>*/}
        {/*            <p className='text-[20px] pt-6 text-white'>Performance cookies </p>*/}
        {/*            <p className='text-[#ffd700] py-1'>These cookies are not strictly necessary but allow us to customize your experience on our websites.*/}
        {/*                The information stored by ‘efficiency cookies’ helps us understand how you use our websites,*/}
        ...
        {/*            </p>*/}
        {/*            <p className='text-[20px] pt-6 text-white'>Targeting or advertising cookies </p>*/}
        {/*            <p className='text-[#ffd700] py-1'>Our goal is to provide visitors to our website with information that best suits them. This is achieved not only through the content of our site but also through advertisements displayed.*/}
        {/*                Since we need to continue display advertisements, we want them to be useful and relevant to you to the extent possible. </p>*/}
        {/*            <p className='text-[#ffd700] py-1'>*/}
        ...
        {/*        </div>*/}
        {/*        <div>*/}
        {/*            <h2 className='font-extrabold text-[36px] text-white'>What types of cookies do we use and for what purposes? </h2>*/}
        {/*            <p className='text-[#ffd700] py-1'>When visiting our websites, you can establish the presence of different types of cookies that are generated. We use all four types of cookies described.*/}
        ...
        {/*        </div>*/}
        {/*        <div>*/}
        {/*            <h2 className='font-extrabold text-[36px] text-white'>Third party cookies: </h2>*/}
        {/*            <p className='text-[#ffd700] py-1'>We also use third-party cookies as part of our services. These cookies are managed by the respective third parties and are not controlled by us. </p>*/}
        {/*            <p className='text-[#ffd700] py-1'>These cookies help us study the market, keep track of income,*/}
        ...
        {/*        </div>*/}
        {/*        <div>*/}
        {/*            <h2 className='font-extrabold text-[36px] text-white'>How to manage cookies? </h2>*/}
        {/*            <p className='text-[#ffd700] py-1'>You can control and/or delete cookies as you wish.*/}
        ...
        {/*        </div>*/}
        {/*        <div>*/}
        {/*            <h2 className='font-extrabold text-[36px] text-white'>Changes to our cookie policy </h2>*/}
        {/*            <p className='text-[#ffd700] py-1'>We reserve the right to change this Cookie Policy and therefore we recommend that you periodically review its content.*/}
        ...
        {/*            </p>*/}
        {/*        </div><div>*/}
        {/*        <h2 className='font-extrabold text-[36px] text-white'>Questions and Feedback </h2>*/}
        {/*        <p className='text-[#ffd700] py-1'>Please send your questions and comments about cookies or privacy at: hello@wetalkdata.ai</p>*/}
        {/*    </div>*/}
        {/*    </div>*/}
        {/*</div>*/}
