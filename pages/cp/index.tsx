        ...
        <div className='py-24 px-10 overflow-hidden'>
            ...
            <div className='text-left space-y-8'>
                <div>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>WeTalkDATA&amp;AI’s website uses cookies.</p>
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>To learn more about what cookies are, how they are used on our websites, and how to manage them, carefully read this Cookie Policy of WeTalkDATA&amp;AI. </p>
                </div>
                <div>
                    <h2 className='font-extrabold 2xl:text-4xl xl:text-3xl text-xl lg:text-2xl text-white'>Cookies – what are they? </h2>
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>A &apos;cookie&apos; is a small file containing data stored on your device&apos;s web browser when visiting specific websites.
                ...
                <div>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>Depending on how long they are stored on your device, cookies are categorized as &lsquo;permanent&rsquo; and &lsquo;temporary&rsquo; (&lsquo;session&rsquo;) cookies.</p>
                    <ul className='text-[#ffd700] list-disc pl-[20px] 2xl:text-lg lg:text-md md:text-sm text-xs pb-2'>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>Depending on their features, cookies can generally be categorized as four different</p>
                    <ul className='text-[#ffd700] list-disc pl-[20px] 2xl:text-lg lg:text-md md:text-sm text-xs'>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>They are strictly necessary for our websites to perform their functions.
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>These cookies deliver the various functionalities of our websites. They enable us to remember your preferences, such as font size and other preferences,
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>These cookies are not strictly necessary but allow us to customize your experience on our websites.
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>Our goal is to provide visitors to our website with information that best suits them. This is achieved not only through the content of our site but also through advertisements displayed.
                ...
                <div>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>When visiting our websites, you can establish the presence of different types of cookies that are generated. We use all four types of cookies described.
                ...
                <div>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>We also use third-party cookies as part of our services. These cookies are managed by the respective third parties and are not controlled by us. </p>
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>These cookies help us study the market, keep track of income,
                ...
                <div>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>You can control and/or delete cookies as you wish.
                ...
                <div>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>We reserve the right to change this Cookie Policy and therefore we recommend that you periodically review its content.
                ...
                <div>
                    ...
                    <p className='text-[#ffd700] py-1 2xl:text-lg lg:text-md md:text-sm text-xs'>Please send your questions and comments about cookies or privacy at: hello&#64;wetalkdata.ai</p>
                </div>
            </div>
        </div>
