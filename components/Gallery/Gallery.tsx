...
const Gallery = () => {
    ...
    return (
        <SectionWrapperContainer>
            <div
                className="inner-wrapper-container h-[47rem] items-center text-center overflow-hidden sm:landscape:min-h-[35rem] md:landscape:min-h-[45rem] lg:landscape:min-h-[59rem] portrait:min-h-[45rem]">
                ...
                <motion.button
                    ...
                    whileTap={{scale: 0.9}}
                    title="asdasd"
                    className="text-[#ffd700] text-[0.75rem] sm:text-[1rem] lg:text-[1.15rem] xl:text-[1.25rem] border-2 border-[#ffd700] px-8 py-3 rounded-full sm:mt-0 tracking-wider hover:bg-gradient-to-br hover:from-blue-800/20 hover:to-[#ffd700]/30 hover:text-[#ffd700]"
                >
